...
fun classRuleSet(page: PageInterface, classNamePrefix: String? = null, rules: RuleSet.() -> Unit): RuleSet {
...
fun classRuleSet(page: PageInterface, classNamePrefix: String? = null, ruleSet: RuleSet): RuleSet {
    val className = page.classNameGenerator.getClassName(classNamePrefix)
    val selector = ClassSelector(className)
